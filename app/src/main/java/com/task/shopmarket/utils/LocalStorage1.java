...
public class LocalStorage1 {
    ...
    private static LocalStorage1 instance = null;

    int PRIVATE_MODE = 0;
    Context _context;

    public LocalStorage1(Context context) {
        sharedPreferences = context.getSharedPreferences(PREF_NAME, Context.MODE_PRIVATE);
        editor = sharedPreferences.edit();
    }

    public static LocalStorage1 getInstance(Context context) {
        if (instance == null) {
            synchronized (LocalStorage1.class) {
                if (instance == null) {
                    instance = new LocalStorage1(context);
                }
            }
        }
        return instance;
